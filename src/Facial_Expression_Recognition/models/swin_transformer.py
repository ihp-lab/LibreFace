...
models_dir = os.path.expanduser('./checkpoints_swin_pretrain')
model_name = {
...
def swin_transformer_tiny(pretrained=True,device='cpu', **kwargs):
	if pretrained:
...
def swin_transformer_small(pretrained=True, device='cpu',**kwargs):
	if pretrained:
		kwargs['init_weights'] = False
...
def swin_transformer_base(pretrained=True,device='cpu', **kwargs):
	if pretrained:
		kwargs['init_weights'] = False
