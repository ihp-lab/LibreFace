...
from libreface.gaze_estimation.inference import estimate_gaze, estimate_gaze_video
...
def get_facial_attributes_image(image_path:str, 
    ...
    some detected facial action units, expressions, and gaze estimation.
    ...
    Returns:
        dict: dictionary containing the following keys
            ...
            gaze_yaw - estimated gaze yaw angle in degrees
            gaze_pitch - estimated gaze pitch angle in degrees
    """
    ...
    gaze = estimate_gaze(aligned_image_path, device=device, weights_download_dir=weights_download_dir)
...
def get_facial_attributes_video(video_path, 
    ...
    facial_expression = get_facial_expression_video(aligned_frames_path_list, 
                                                    ...
                                                    batch_size=batch_size,
                                                    weights_download_dir=weights_download_dir)
    gaze = estimate_gaze_video(aligned_frames_path_list,
                               device=device,
                               batch_size=batch_size,
                               num_workers=num_workers,
                               weights_download_dir=weights_download_dir)
